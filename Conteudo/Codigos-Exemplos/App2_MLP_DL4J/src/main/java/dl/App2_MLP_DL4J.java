...
public class App2_MLP_DL4J {
    private static int label_index = 7; //9
    private static int n_classes = 2; //3
    ...
    private static void doETL_AndSave(Dataset<Row> training_data) {
        ...
        Dataset<Row> relevant_not_null_only_numeric_training_data
                ...
                .drop("Sex", "Embarked");
        relevant_not_null_only_numeric_training_data.show();//3
...
System.out.println("Teste 4");
    ...
    MultiLayerNetwork model = new MultiLayerNetwork(MLPconfiguration);
        model.init();
    ...
    private static void evaluateNetwork(MultiLayerNetwork model) throws IOException, InterruptedException {
